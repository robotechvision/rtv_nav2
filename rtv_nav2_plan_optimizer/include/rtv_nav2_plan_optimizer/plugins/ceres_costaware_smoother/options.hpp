...
#ifndef RTV_NAV2_SMAC_PLANNER__OPTIONS_HPP_
#define RTV_NAV2_SMAC_PLANNER__OPTIONS_HPP_
...
struct SmootherParams
{
  ...
  void get(rclcpp_lifecycle::LifecycleNode * node, const std::string & name)
  {
    ...
    if (cost_check_points.size()%3 != 0) {
      RCLCPP_ERROR(rclcpp::get_logger("rclcpp"), "cost_check_points parameter must contain values as follows: [x1, y1, weight1, x2, y2, weight2, ...]");
      rclcpp::shutdown();
    }
  }
...
#endif  // RTV_NAV2_SMAC_PLANNER__OPTIONS_HPP_
